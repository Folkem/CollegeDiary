...
<head>
    ...
    <link rel="stylesheet" href="../../css/control-panel/users.css">
    <script src="../../js/sections.js"></script>
    <script src="../../js/control-panel/general/functions.js"></script>
    <script src="../../js/control-panel/users/requests.js"></script>
    <script src="../../js/control-panel/users/elements.js"></script>
    <script src="../../js/control-panel/users/main.js"></script>
</head>
<body>
