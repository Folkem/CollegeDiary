...
@section('title', 'Додавання домашнього завдання')
...
@section('body')
    ...
    <main class="max-w-1200 flex flex-col gap-6 mx-auto pt-20 text-blue-900">
        <div class="text-xl sm:text-2xl md:text-3xl font-gotham-pro-bold mx-auto text-center">
            Додавання домашнього завдання до дисципліни {{ $discipline->forTeacher }}
        </div>
        ...
        @endif
        <form action="{{ route('homeworks.store', $discipline) }}" method="post"
            ...
            <div class="flex flex-col gap-2">
                ...
                <input type="datetime-local" required id="ending_at" name="ending_at" placeholder="Дата сдачі"
                       class="rounded-full px-3 py-1 text-lg border border-solid border-blue-900 w-full bg-white"
                       value="{{ old('ending_at') }}">
                @error('ending_at')
