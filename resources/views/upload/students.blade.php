...
@section('title', 'Завантаження студентів з Excel-файлу')
...
@section('body')
    ...
    <main class="max-w-1200 flex flex-col gap-4 mx-auto font-gotham-pro p-4">
        <div class="text-center text-xl sm:text-2xl lg:text-3xl p-4 w-full">
            Завантаження студентів з Excel-файлу
        </div>
        @if($errors->any())
        ...
        @endif
        <form action="{{ route('upload.students.upload') }}" enctype="multipart/form-data" method="post"
